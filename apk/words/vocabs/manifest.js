(() => {
  const packs = [
    ...
    },
    {
      ...
      weight: 1,
      files: [
        "words/vocabs/05_鍒濅腑/junior_high_basic.js",
      ],
      getRaw() {
                    return [
    ...
    },
    {
      ...
      weight: 1,
      files: [
        "words/vocabs/05_鍒濅腑/junior_high_intermediate.js",
      ],
      getRaw() {
                    return [
    ...
    },
    {
      ...
      weight: 1,
      files: [
        "words/vocabs/05_鍒濅腑/junior_high_advanced.js",
      ],
      getRaw() {
                    return [
    ...
    },
    {
      ...
      weight: 1,
      files: [
        "words/vocabs/05_鍒濅腑/junior_high_full.js",
      ],
      getRaw() {
                    return [

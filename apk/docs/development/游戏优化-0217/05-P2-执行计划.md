...
创建 `tests/p2-boss-visual.spec.js`：
...
```bash
npm test -- tests/p2-boss-visual.spec.js
```
...
- `build.gradle`: `versionCode 101`, `versionName "1.18.0"`
...
git add apk/package.json apk/android-app/android/app/build.gradle \
       apk/src/modules/15-entities-boss.js \
       apk/docs/version/ tests/p2-boss-visual.spec.js \

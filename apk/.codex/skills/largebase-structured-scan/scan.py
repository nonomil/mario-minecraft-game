...
用法示例:
  python .codex/skills/largebase-structured-scan/scan.py scan --mode M4 --scope . --topic refactor-core
  python .codex/skills/largebase-structured-scan/scan.py scan --mode M2 --scope src docs --topic feature-x --refs docs/api.md docs/config.md
  python .codex/skills/largebase-structured-scan/scan.py load --load docs/scan/2026-02-26-refactor-core/scan-data.json --db docs/scan/2026-02-26-refactor-core/scan.db
  python .codex/skills/largebase-structured-scan/scan.py query --query hybrid_search --type all --db docs/scan/2026-02-26-refactor-core/scan.db
  python .codex/skills/largebase-structured-scan/scan.py export-to-claude-md --db docs/scan/2026-02-26-refactor-core/scan.db --claude-md CLAUDE.md
  python .codex/skills/largebase-structured-scan/scan.py measure --scope . src --output docs/scan/measure.json
"""

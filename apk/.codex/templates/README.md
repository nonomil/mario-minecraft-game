...
本目录包含 Codex + Claude Code MCP 协作中使用的模板文件。
...
**何时使用**：
- 执行 `codex-workflow-largebase.md` 中的结构化扫描
- 需要产出 00-06 扫描包时
...
**参考**：见 `codex-workflow-largebase.md` 中的"扫描包标准"
...
**何时使用**：
- 执行 `codex-workflow-parallel.md` 中的并行开发
- 需要定义多个任务的影响范围时
...
**参考**：见 `codex-workflow-parallel.md` 中的"影响范围分析"
...
- `../workflows/codex-workflow-largebase.md` — 大型库工作流（使用扫描包模板）
- `../workflows/codex-workflow-parallel.md` — 并行开发工作流（使用影响范围模板）
- `../workflows/codex-workflow-constants.md` — 全局约束（扫描包标准）
- `../README.md` — .claude 目录完整指南


---

### 5. `codex-config.sample.toml`
**用途**：Codex 主控配置样例

**何时使用**：
- 新机器初始化 Codex
- 需要把 `CODEX.md` 纳入 fallback 文档时

**包含内容**：
- 模型与沙箱策略
- `project_doc_fallback_filenames` 示例
- `mcp_servers.claude` 配置示例

**参考**：`../workflows/codex-workflow-constants.md` 中的主流程与兼容规范

## v1.18.15（发布日期：2026-02-19）
- 类型：PATCH
- APK 版本：versionName = 1.18.15，versionCode = 15
- 主要变更
  - 需求7室内模式落地：房屋可进入/可退出，室内床恢复与词屋挑战闭环
  - 室内与外部系统互斥：BOSS/门禁/群系切换与室内状态双向守卫
  - 新增触控室内退出按钮（🚪）与 Esc 退出路径，异常重开自动重置室内状态
  - 修复首页与样式乱码显示问题
  - 修复版本读取 BOM 回退导致错误发布版本的问题
  - 统一版本源并更新 Release 文案模板
